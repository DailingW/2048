...
SUBMIT := $(wildcard src/main/java/org/cis1200/**/*.java src/test/java/org/cis1200/**/*.java src/main/java/org/cis1200/org.cis1200.play2048.Game.java files/** README.txt)
